    ...
    if batch_mode == True:
        ...
        with open(outfile, 'a+') as f:
            if write_header == True:
                f.write('Simulation time (Myr),Time step (yr),Model thickness (km),Node points,'
            ...
            f.write('{0:.4f},{1:.4f},{2:.4f},{3},{4:.4f},{5:.4},{6},{7:.4f},{8:.4f},'
                    ...
                    '\n'.format(t_total / myr2sec(1), dt / yr2sec(1), L / kilo2base(1), nx, Tsurf, \
                                Tbase, mantle_adiabat, rho_crust, removal_fraction, erotype, \
                                ...
                                ap_rad, ap_U, ap_Th, zr_rad, zr_U, zr_Th, float(corr_ahe_age), \
