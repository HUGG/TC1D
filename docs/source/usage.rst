...
.. note::
   ...
   In order for T\ :sub:`c`\ 1D to work properly you will also need the thermochronometer age prediction programs available in the `T\ :sub:`c`\ 1D core package <https://github.com/HUGG/Tc_core/>`__.
